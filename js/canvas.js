...
//Canvas.prototype = Object.create(Progress.prototype);
//Canvas.prototype.constructor = Canvas;
...
Canvas.prototype.logs = function (clr) {
    ...
    $(".logs").append('<span class="clr-chit">'+clr+'<small class="removeclrchit close" style="cursor: pointer;margin: 0 16px;">✖</small></span>');
...
/*
Canvas.prototype.rotateAnimation = function (angle) {
    var ctx = this.ctx;
